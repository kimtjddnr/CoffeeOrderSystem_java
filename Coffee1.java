...
class Coffee1 extends Frame implements ActionListener
{
	...
	public Coffee1() 
	{
        ...
        for (int i = 0; i < menu.length; i++) {
        	...
        	//set image to button
            list[i] = new JButton(new ImageIcon("C:\\Users\\82108\\eclipse-workspace\\CoffeeOrderSystem\\image\\ÇÖ\\"+i+".png"));
            if (i < 4) {
        ...
        for (int i = 0; i < menu.length; i++) {
            ...
            save[i].addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    int length=menu[j].length();
                    int Maxlength=11;
                    OrderText.append(menu[j]+"   " + show + "       " + price[j] + "        " + count + "         " + price[j] * count
                            + "won" + "\n");
