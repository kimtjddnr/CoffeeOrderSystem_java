...
class Coffee1 extends Frame implements ActionListener
{
	...
	Coffee1() 
	{
        ...
        String menu[] = { "Americano", "Cappuccino", "Caffe Latte", "hazelnut Latte", "Caramel macchiato", "Toffeenut Latte", "Green tea Latte", "Espresso" };
        int price[] = { 5000,5000,5000,5000,5000,5000,5000,5000};
...
class Coffee2 extends Frame implements ActionListener
{
	...
	public Coffee2() 
	{
        ...
        String menu[] = { "Vienna Coffee", "Ice Americano", "Cold Brew", "Dutch Coffee", "Ice Vanilla Latte", "Ice Hazelnut", "einspanner", "Ice Cafe Latte" };
